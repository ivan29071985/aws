...
describe('Módulo - Classificação-medica', () => {
    ...
    describe('Módulo - Classificação-medica', () => {
        ...
        it('Validar retorno 200 (falso)- /api/v1/attendance/medical-classifications', () => {
            const token = Cypress.env('access_token');
            ...
            cy.request({
                ...
                qs: {
                    typeMedicalClassification: 3,
                    medicalClassification: 'Risco 45',
                    limit: 5
                },
                failOnStatusCode: false,
            }).then((response) => {
        ...
        it('Validar retorno 404 - /api/v1/attendance/medical-classifications', () => {
            const token = Cypress.env('access_token');
